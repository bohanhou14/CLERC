...
def cli():
    ...
    parser.add_argument("data", type=str, help="path to the dataset or raw data")
    ...
    parser.add_argument("--mapping_path", type=str, help="path to mapping file (pid2did)")
    ...
    parser.add_argument("--cites_path", type=str, help="path to cites2did.pkl")
...
def main(args):
    if args.task == 'process_raw':
        print("This task is meant to process raw data, not for building collections.")
        print("The raw data is a jsonl.gz file containing case documents, taken from case.law")
        ...
        print("Building and also classifying queries...")
        ...
        print("Removing the central citation sentences from the queries...")
        filter_queries(args.data, num_queries=args.n, option='single')
    elif args.task == 'filter_queries_all':
        print("Removing all the citation sentences from the queries...")
